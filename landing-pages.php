...
define(__NAMESPACE__.'\LANDING_ID_URL', 'https://api.activedemand.com/v1/cta_pages.json');
define(__NAMESPACE__.'\LANDING_HTML_URL', 'https://api.activedemand.com/v1/cta_pages/');
...
function activedemand_landingpage_scripts(){
  ...
  */
  ...
  add_action('save_post', __NAMESPACE__.'\activedemand_save_landing_page');
    ...
    if(!wp_verify_nonce($_POST[PREFIX.'-landing-nonce'], 'ad_landing-'.$post_id)) return;
